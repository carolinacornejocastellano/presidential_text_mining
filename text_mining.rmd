...
links <- paste0(
  "https://raw.githubusercontent.com/cornejocastellano/presidential_text_mining/main/",
...
After that, the speeches were downloaded from the [GitHub](https://github.com/cornejocastellano/presidential_text_mining) repository. In this way, a dataframe with 3 columns was obtained: president, date and the entire speech in a single line for each president:
